...
# This a copy of dicm_to_nii_all_3.sh only to check first two days data
...
mkdir /mnt/hcp01/test_folder/$sub_num
...
do
        ...
        echo ${arr[$((i-1))]}
	/mnt/jxvs01/pipelines/HCP/usr/local/MATLAB/R2016b/bin/matlab -nodisplay -r "dicm2nii('/mnt/jxvs01/incoming/Smoking_Cessation_Abi_Dargham/${arr[$((i-1))]}', '/mnt/hcp01/test_folder/$sub_num/day_$i', 0); quit"
done
