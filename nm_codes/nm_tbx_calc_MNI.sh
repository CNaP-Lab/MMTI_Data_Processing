...
# insert commas to Subject numbers list to use on Matlab
y=$(IFS=,; echo "${sub_num[*]}")

replace "Subject_number_list" "${y}" -- compile_results_vmdata_cp.m

matlab -nodisplay -r "compile_results_vmdata_cp; quit"
