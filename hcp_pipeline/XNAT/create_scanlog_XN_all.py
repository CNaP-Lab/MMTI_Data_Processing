...
while os.path.isdir(current_dir):
    ...
    for i in os.listdir(current_dir):
        ...
        if os.path.isdir(next_level):
            ...
            elif 'FUNC TOPUP RPE' in filename:
...
for i in range(len(mapoutlist)):
    ...
    for j in range(len(mapoutcont[i])):
        ...
        if 'B0_fieldmap' in  q[j]:
            ...
            allstring[allstudy.index(whichstudy)].append(' ' + str(s[j]) + ' 12:00 ' +  str(r[j]) + ' ' + q[j] + ' ' + str(previousb0echo))
        ...
        if 'fMRI' in q[j]:
            ...
            if h%2:
                allstring[allstudy.index(whichstudy)].append(' ' + s[j] + ' 12:00 ' +  str(r[j]) + ' ' + q[j] + str(h) + ' ' + str(previouspaecho) + ' ' + str(previousb0echo) + ' 1')

            else:
                allstring[allstudy.index(whichstudy)].append(' ' + s[j] + ' 12:00 ' +  str(r[j]) + ' ' + q[j] + str(h) + ' ' + str(previousapecho) + ' ' + str(previousb0echo) + ' 2')
