...
subjdir = raw_input("Enter the final subject directory full path ? ")
...
# scan_file = raw_input("Enter scnalog file ? ")
...
f.write("set scanlog = "+cwd+"/"+data_id+"_scanlog_B0EPI0.txt\n")
