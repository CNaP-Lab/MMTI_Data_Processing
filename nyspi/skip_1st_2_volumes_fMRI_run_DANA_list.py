"""
	Developed by Sameera K. Abeykoon ( July 10th 2018)
        This script will skip the volumes from the .nii.gz file for a subject list
        from DANA data
        Need to get py35_nib environment
...
if __name__ == "__main__":
    ...
    # final Subject folder inside hcp01/dana_nyspi
    # s_folder = s_number # + "_B0EPI0"
    for s_folder in s_list:
        # final data folder
        fd_folder = "/mnt/hcp01/dana_nyspi/" + str(s_folder) + "/unprocessed/3T"
